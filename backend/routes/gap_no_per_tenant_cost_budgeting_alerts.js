...
// Batch 10 Gap: "No per-tenant cost budgeting / alerts (cost-summary endpoint only)" (nonai-gap) for mcpServer
// Mount path: /api/gap-no-per-tenant-cost-budgeting-alerts
