...
// Batch 10 Gap: "RAG endpoint present () but multi-modal RAG (code, text, images) not surfaced" (ai-gap) for mcpServer
// Mount path: /api/gap-rag-endpoint-present-but-multi-modal
