...
// Batch 10 Gap: "No deployment management (rolling deploy / canary for agents)" (nonai-gap) for mcpServer
// Mount path: /api/gap-no-deployment-management-rolling-deploy-canary
