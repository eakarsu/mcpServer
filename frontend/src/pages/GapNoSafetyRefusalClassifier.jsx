...
// Batch 10 frontend page: "No safety / refusal classifier" (ai-gap) — mcpServer
import React, { useEffect, useState } from 'react';

const SLUG = "no-safety-refusal-classifier";
const LABEL = "No safety / refusal classifier";
const SECTION = "ai-gap";
const API_PATH = "/api/gap-no-safety-refusal-classifier";

export default function GapNoSafetyRefusalClassifier() {
