...
// Batch 10 frontend page: "Voice-to-action front door (voice → MCP tool invocation)" (cfs) — mcpServer
import React, { useEffect, useState } from 'react';

const SLUG = "voice-to-action-front-door-voice";
const LABEL = "Voice-to-action front door (voice → MCP tool invocation)";
const SECTION = "cfs";
const API_PATH = "/api/cf-voice-to-action-front-door-voice";

export default function CfVoiceToActionFrontDoorVoice() {
