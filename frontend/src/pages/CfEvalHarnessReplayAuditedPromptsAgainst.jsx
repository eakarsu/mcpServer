...
// Batch 10 frontend page: "Eval harness — replay audited prompts against new models" (cfs) — mcpServer
import React, { useEffect, useState } from 'react';

const SLUG = "eval-harness-replay-audited-prompts-against";
const LABEL = "Eval harness — replay audited prompts against new models";
const SECTION = "cfs";
const API_PATH = "/api/cf-eval-harness-replay-audited-prompts-against";

export default function CfEvalHarnessReplayAuditedPromptsAgainst() {
