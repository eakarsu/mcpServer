...
// Batch 10 frontend page: "No fine-grained RBAC per agent / workflow" (nonai-gap) — mcpServer
import React, { useEffect, useState } from 'react';

const SLUG = "no-fine-grained-rbac-per-agent";
const LABEL = "No fine-grained RBAC per agent / workflow";
const SECTION = "nonai-gap";
const API_PATH = "/api/gap-no-fine-grained-rbac-per-agent";

export default function GapNoFineGrainedRbacPerAgent() {
