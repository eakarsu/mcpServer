...
// Batch 10 frontend page: "No prompt-eval harness" (ai-gap) — mcpServer
import React, { useEffect, useState } from 'react';

const SLUG = "no-prompt-eval-harness";
const LABEL = "No prompt-eval harness";
const SECTION = "ai-gap";
const API_PATH = "/api/gap-no-prompt-eval-harness";

export default function GapNoPromptEvalHarness() {
