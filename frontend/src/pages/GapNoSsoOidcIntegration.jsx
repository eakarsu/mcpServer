...
// Batch 10 frontend page: "No SSO / OIDC integration" (nonai-gap) — mcpServer
import React, { useEffect, useState } from 'react';

const SLUG = "no-sso-oidc-integration";
const LABEL = "No SSO / OIDC integration";
const SECTION = "nonai-gap";
const API_PATH = "/api/gap-no-sso-oidc-integration";

export default function GapNoSsoOidcIntegration() {
